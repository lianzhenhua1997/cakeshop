				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<a
								href="${pageContext.request.contextPath }/goodsDetail_list?id=${item.key}">
								<img
						...
						<div class="cart-item-info">
							<h3>
								<a
									href="${pageContext.request.contextPath }/goodsDetail_list?id=${item.key}">${item.value.goods.name}</a>
							</h3>
							<h3>
